<?php
    ...
    if($lead_id == null) { 
        ...
        $query = "SELECT lead_id,list_id,first_name,middle_initial,last_name,email,phone_number,alt_phone,address1,address2,address3,city,state,province,postal_code,country_code,gender,status,user FROM vicidial_list where lead_id='$lead_id'";
