...
=======
			$answering_machine_detection = '8369';	
>>>>>>> 938ef479e5c16bcb3c72cca0facbbf1aaef1e4c2
		}
	}
		...
		$campNum = mysqli_num_rows($rsltvCampID);
                		...
                		if ($campNum < 1){
                            ...
                            $queryAdd = "INSERT INTO vicidial_campaigns (
										...
										VALUES(
=======
			$queryUsergroup = mysqli_query($link, "SELECT user_group FROM vicidial_user_groups WHERE user_group = '$user_group';");
			$num_usergroups = mysqli_num_rows($queryUsergorup);
...
>>>>>>> 938ef479e5c16bcb3c72cca0facbbf1aaef1e4c2
					...
					if($campaign_type == "COPY"){
							...
							$queryAddCopy = "INSERT INTO vicidial_campaigns (
											campaign_id, campaign_name, dial_method, auto_dial_level,
											active,dial_status_a,dial_status_b,dial_status_c,dial_status_d,dial_status_e,lead_order,
											park_ext,park_file_name,web_form_address,allow_closers,hopper_level,next_agent_call,local_call_time,
											voicemail_ext,dial_timeout,dial_prefix,campaign_cid,campaign_vdad_exten,campaign_rec_exten,campaign_recording,
											campaign_rec_filename,campaign_script,get_call_launch,am_message_exten,amd_send_to_vmx,xferconf_a_dtmf,xferconf_a_number,
											xferconf_b_dtmf,xferconf_b_number,alt_number_dialing,scheduled_callbacks,lead_filter_id,drop_call_seconds,drop_action,
											safe_harbor_exten,display_dialable_count,wrapup_seconds,wrapup_message,closer_campaigns,use_internal_dnc,allcalls_delay,
											omit_phone_code,available_only_ratio_tally,adaptive_dropped_percentage,adaptive_maximum_level,adaptive_latest_server_time,adaptive_intensity,adaptive_dl_diff_target,
											concurrent_transfers,auto_alt_dial,auto_alt_dial_statuses,agent_pause_codes_active,campaign_description,campaign_changedate,campaign_stats_refresh,
											campaign_logindate,dial_statuses,disable_alter_custdata,no_hopper_leads_logins,list_order_mix,campaign_allow_inbound,manual_dial_list_id,
											default_xfer_group,xfer_groups,queue_priority,drop_inbound_group,qc_enabled,qc_statuses,qc_lists,
											qc_shift_id,qc_get_record_launch,qc_show_recording,qc_web_form_address,qc_script,survey_first_audio_file,survey_dtmf_digits,
											survey_ni_digit,survey_opt_in_audio_file,survey_ni_audio_file,survey_method,survey_no_response_action,survey_ni_status,survey_response_digit_map,
											survey_xfer_exten,survey_camp_record_dir,disable_alter_custphone,display_queue_count,manual_dial_filter,agent_clipboard_copy,agent_extended_alt_dial,
											use_campaign_dnc,three_way_call_cid,three_way_dial_prefix,web_form_target,vtiger_search_category,vtiger_create_call_record,vtiger_create_lead_record,
											vtiger_screen_login,cpd_amd_action,agent_allow_group_alias,default_group_alias,vtiger_search_dead,vtiger_status_call,survey_third_digit,
											survey_third_audio_file,survey_third_status,survey_third_exten,survey_fourth_digit,survey_fourth_audio_file,survey_fourth_status,survey_fourth_exten,
											drop_lockout_time,quick_transfer_button,prepopulate_transfer_preset,drop_rate_group,view_calls_in_queue,view_calls_in_queue_launch,grab_calls_in_queue,
											call_requeue_button,pause_after_each_call,no_hopper_dialing,agent_dial_owner_only,agent_display_dialable_leads,web_form_address_two,waitforsilence_options,
											agent_select_territories,campaign_calldate,crm_popup_login,crm_login_address,timer_action,timer_action_message,timer_action_seconds,
											start_call_url,dispo_call_url,xferconf_c_number,xferconf_d_number,xferconf_e_number,use_custom_cid,scheduled_callbacks_alert,
											queuemetrics_callstatus_override,extension_appended_cidname,scheduled_callbacks_count,manual_dial_override,blind_monitor_warning,blind_monitor_message,blind_monitor_filename,
											inbound_queue_no_dial,timer_action_destination,enable_xfer_presets,hide_xfer_number_to_dial,manual_dial_prefix,customer_3way_hangup_logging,customer_3way_hangup_seconds,
											customer_3way_hangup_action,ivr_park_call,ivr_park_call_agi,manual_preview_dial,realtime_agent_time_stats,use_auto_hopper,auto_hopper_multi,
											auto_hopper_level,auto_trim_hopper,api_manual_dial,manual_dial_call_time_check,display_leads_count,lead_order_randomize,lead_order_secondary,
											per_call_notes,my_callback_option,agent_lead_search,agent_lead_search_method,queuemetrics_phone_environment,auto_pause_precall,auto_pause_precall_code,
											auto_resume_precall,manual_dial_cid,post_phone_time_diff_alert,custom_3way_button_transfer,available_only_tally_threshold,available_only_tally_threshold_agents,dial_level_threshold,
											dial_level_threshold_agents,safe_harbor_audio,safe_harbor_menu_id,survey_menu_id,callback_days_limit,dl_diff_target_method,disable_dispo_screen,
											disable_dispo_status,screen_labels,status_display_fields,na_call_url,survey_recording,pllb_grouping,pllb_grouping_limit,
											call_count_limit,call_count_target,callback_hours_block,callback_list_calltime,user_group,hopper_vlc_dup_check,in_group_dial,
											in_group_dial_select,safe_harbor_audio_field,pause_after_next_call,owner_populate,use_other_campaign_dnc,allow_emails,amd_inbound_group,
											amd_callmenu,survey_wait_sec,manual_dial_lead_id,dead_max,dead_max_dispo,dispo_max,dispo_max_dispo,
											pause_max,max_inbound_calls,manual_dial_search_checkbox,hide_call_log_info,timer_alt_seconds,wrapup_bypass,wrapup_after_hotkey,
											callback_active_limit,callback_active_limit_override,allow_chats,comments_all_tabs,comments_dispo_screen,comments_callback_screen,qc_comment_history,
											show_previous_callback,clear_script,cpd_unknown_action,manual_dial_search_filter,web_form_address_three,manual_dial_override_field,status_display_ingroup,
											customer_gone_seconds,agent_display_fields,am_message_wildcards,manual_dial_timeout,routing_initiated_recordings,manual_dial_hopper_check,callback_useronly_move_minutes,
											ofcom_uk_drop_calc
									)
									VALUES(
											'$campaign_id', '$campaign_name', '$dial_method', '$autoDialLevel',
											'$active_FROMARRAY','$dial_status_a_FROMARRAY','$dial_status_b_FROMARRAY','$dial_status_c_FROMARRAY','$dial_status_d_FROMARRAY','$dial_status_e_FROMARRAY','$lead_order_FROMARRAY',
											'$park_ext_FROMARRAY','$park_file_name_FROMARRAY','$web_form_address_FROMARRAY','$allow_closers_FROMARRAY','$hopper_level_FROMARRAY','$next_agent_call_FROMARRAY','$local_call_time_FROMARRAY',
											'$voicemail_ext_FROMARRAY','$dial_timeout_FROMARRAY','$dial_prefix_FROMARRAY','$campaign_cid_FROMARRAY','$campaign_vdad_exten_FROMARRAY','$campaign_rec_exten_FROMARRAY','$campaign_recording_FROMARRAY',
											'$campaign_rec_filename_FROMARRAY','$campaign_script_FROMARRAY','$get_call_launch_FROMARRAY','$am_message_exten_FROMARRAY','$amd_send_to_vmx_FROMARRAY','$xferconf_a_dtmf_FROMARRAY','$xferconf_a_number_FROMARRAY',
											'$xferconf_b_dtmf_FROMARRAY','$xferconf_b_number_FROMARRAY','$alt_number_dialing_FROMARRAY','$scheduled_callbacks_FROMARRAY','$lead_filter_id_FROMARRAY','$drop_call_seconds_FROMARRAY','$drop_action_FROMARRAY',
											'$safe_harbor_exten_FROMARRAY','$display_dialable_count_FROMARRAY','$wrapup_seconds_FROMARRAY','$wrapup_message_FROMARRAY','$closer_campaigns_FROMARRAY','$use_internal_dnc_FROMARRAY','$allcalls_delay_FROMARRAY',
											'$omit_phone_code_FROMARRAY','$available_only_ratio_tally_FROMARRAY','$adaptive_dropped_percentage_FROMARRAY','$adaptive_maximum_level_FROMARRAY','$adaptive_latest_server_time_FROMARRAY','$adaptive_intensity_FROMARRAY','$adaptive_dl_diff_target_FROMARRAY',
											'$concurrent_transfers_FROMARRAY','$auto_alt_dial_FROMARRAY','$auto_alt_dial_statuses_FROMARRAY','$agent_pause_codes_active_FROMARRAY','$campaign_description_FROMARRAY','$campaign_changedate_FROMARRAY','$campaign_stats_refresh_FROMARRAY',
											'$campaign_logindate_FROMARRAY','$dial_statuses_FROMARRAY','$disable_alter_custdata_FROMARRAY','$no_hopper_leads_logins_FROMARRAY','$list_order_mix_FROMARRAY','$campaign_allow_inbound_FROMARRAY','$manual_dial_list_id_FROMARRAY',
											'$default_xfer_group_FROMARRAY','$xfer_groups_FROMARRAY','$queue_priority_FROMARRAY','$drop_inbound_group_FROMARRAY','$qc_enabled_FROMARRAY','$qc_statuses_FROMARRAY','$qc_lists_FROMARRAY',
											'$qc_shift_id_FROMARRAY','$qc_get_record_launch_FROMARRAY','$qc_show_recording_FROMARRAY','$qc_web_form_address_FROMARRAY','$qc_script_FROMARRAY','$survey_first_audio_file_FROMARRAY','$survey_dtmf_digits_FROMARRAY',
											'$survey_ni_digit_FROMARRAY','$survey_opt_in_audio_file_FROMARRAY','$survey_ni_audio_file_FROMARRAY','$survey_method_FROMARRAY','$survey_no_response_action_FROMARRAY','$survey_ni_status_FROMARRAY','',
											'$survey_xfer_exten_FROMARRAY','$survey_camp_record_dir_FROMARRAY','$disable_alter_custphone_FROMARRAY','$display_queue_count_FROMARRAY','$manual_dial_filter_FROMARRAY','$agent_clipboard_copy_FROMARRAY','$agent_extended_alt_dial_FROMARRAY',
											'$use_campaign_dnc_FROMARRAY','$three_way_call_cid_FROMARRAY','$three_way_dial_prefix_FROMARRAY','$web_form_target_FROMARRAY','$vtiger_search_category_FROMARRAY','$vtiger_create_call_record_FROMARRAY','$vtiger_create_lead_record_FROMARRAY',
											'$vtiger_screen_login_FROMARRAY','$cpd_amd_action_FROMARRAY','$agent_allow_group_alias_FROMARRAY','$default_group_alias_FROMARRAY','$vtiger_search_dead_FROMARRAY','$vtiger_status_call_FROMARRAY','$survey_third_digit_FROMARRAY',
											'$survey_third_audio_file_FROMARRAY','$survey_third_status_FROMARRAY','$survey_third_exten_FROMARRAY','$survey_fourth_digit_FROMARRAY','$survey_fourth_audio_file_FROMARRAY','$survey_fourth_status_FROMARRAY','$survey_fourth_exten_FROMARRAY',
											'$drop_lockout_time_FROMARRAY','$quick_transfer_button_FROMARRAY','$prepopulate_transfer_preset_FROMARRAY','$drop_rate_group_FROMARRAY','$view_calls_in_queue_FROMARRAY','$view_calls_in_queue_launch_FROMARRAY','$grab_calls_in_queue_FROMARRAY',
											'$call_requeue_button_FROMARRAY','$pause_after_each_call_FROMARRAY','$no_hopper_dialing_FROMARRAY','$agent_dial_owner_only_FROMARRAY','$agent_display_dialable_leads_FROMARRAY','$web_form_address_two_FROMARRAY','$waitforsilence_options_FROMARRAY',
											'$agent_select_territories_FROMARRAY','$campaign_calldate_FROMARRAY','$crm_popup_login_FROMARRAY','$crm_login_address_FROMARRAY','$timer_action_FROMARRAY','$timer_action_message_FROMARRAY','$timer_action_seconds_FROMARRAY',
											'$start_call_url_FROMARRAY','$dispo_call_url_FROMARRAY','$xferconf_c_number_FROMARRAY','$xferconf_d_number_FROMARRAY','$xferconf_e_number_FROMARRAY','$use_custom_cid_FROMARRAY','$scheduled_callbacks_alert_FROMARRAY',
											'$queuemetrics_callstatus_override_FROMARRAY','$extension_appended_cidname_FROMARRAY','$scheduled_callbacks_count_FROMARRAY','$manual_dial_override_FROMARRAY','$blind_monitor_warning_FROMARRAY','$blind_monitor_message_FROMARRAY','$blind_monitor_filename_FROMARRAY',
											'$inbound_queue_no_dial_FROMARRAY','$timer_action_destination_FROMARRAY','$enable_xfer_presets_FROMARRAY','$hide_xfer_number_to_dial_FROMARRAY','$manual_dial_prefix_FROMARRAY','$customer_3way_hangup_logging_FROMARRAY','$customer_3way_hangup_seconds_FROMARRAY',
											'$customer_3way_hangup_action_FROMARRAY','$ivr_park_call_FROMARRAY','$ivr_park_call_agi_FROMARRAY','$manual_preview_dial_FROMARRAY','$realtime_agent_time_stats_FROMARRAY','$use_auto_hopper_FROMARRAY','$auto_hopper_multi_FROMARRAY',
											'$auto_hopper_level_FROMARRAY','$auto_trim_hopper_FROMARRAY','$api_manual_dial_FROMARRAY','$manual_dial_call_time_check_FROMARRAY','$display_leads_count_FROMARRAY','$lead_order_randomize_FROMARRAY','$lead_order_secondary_FROMARRAY',
											'$per_call_notes_FROMARRAY','$my_callback_option_FROMARRAY','$agent_lead_search_FROMARRAY','$agent_lead_search_method_FROMARRAY','$queuemetrics_phone_environment_FROMARRAY','$auto_pause_precall_FROMARRAY','$auto_pause_precall_code_FROMARRAY',
											'$auto_resume_precall_FROMARRAY','$manual_dial_cid_FROMARRAY','$post_phone_time_diff_alert_FROMARRAY','$custom_3way_button_transfer_FROMARRAY','$available_only_tally_threshold_FROMARRAY','$available_only_tally_threshold_agents_FROMARRAY','$dial_level_threshold_FROMARRAY',
											'$dial_level_threshold_agents_FROMARRAY','$safe_harbor_audio_FROMARRAY','$safe_harbor_menu_id_FROMARRAY','$survey_menu_id_FROMARRAY','$callback_days_limit_FROMARRAY','$dl_diff_target_method_FROMARRAY','$disable_dispo_screen_FROMARRAY',
											'$disable_dispo_status_FROMARRAY','$screen_labels_FROMARRAY','$status_display_fields_FROMARRAY','$na_call_url_FROMARRAY','$survey_recording_FROMARRAY','$pllb_grouping_FROMARRAY','$pllb_grouping_limit_FROMARRAY',
											'$call_count_limit_FROMARRAY','$call_count_target_FROMARRAY','$callback_hours_block_FROMARRAY','$callback_list_calltime_FROMARRAY','$user_group_FROMARRAY','$hopper_vlc_dup_check_FROMARRAY','$in_group_dial_FROMARRAY',
											'$in_group_dial_select_FROMARRAY','$safe_harbor_audio_field_FROMARRAY','$pause_after_next_call_FROMARRAY','$owner_populate_FROMARRAY','$use_other_campaign_dnc_FROMARRAY','$allow_emails_FROMARRAY','$amd_inbound_group_FROMARRAY',
											'$amd_callmenu_FROMARRAY','$survey_wait_sec_FROMARRAY','$manual_dial_lead_id_FROMARRAY','$dead_max_FROMARRAY','$dead_max_dispo_FROMARRAY','$dispo_max_FROMARRAY','$dispo_max_dispo_FROMARRAY',
											'$pause_max_FROMARRAY','$max_inbound_calls_FROMARRAY','$manual_dial_search_checkbox_FROMARRAY','$hide_call_log_info_FROMARRAY','$timer_alt_seconds_FROMARRAY','$wrapup_bypass_FROMARRAY','$wrapup_after_hotkey_FROMARRAY',
											'$callback_active_limit_FROMARRAY','$callback_active_limit_override_FROMARRAY','$allow_chats_FROMARRAY','$comments_all_tabs_FROMARRAY','$comments_dispo_screen_FROMARRAY','$comments_callback_screen_FROMARRAY','$qc_comment_history_FROMARRAY',
