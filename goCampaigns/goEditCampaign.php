			...
			if ( $astDB->count > 0 ) {
				...
				if ( in_array($campaign_id, $allowed_campaigns)) {						
					...
					$data_array03							= array(
						...
						'call_count_limit' 						=> (!empty($call_count_limit)) ? $call_count_limit : $resultGet['call_count_limit'],
						'call_count_target' 					=> (!empty($call_count_target)) ? $call_count_target : $resultGet['call_count_target'],
