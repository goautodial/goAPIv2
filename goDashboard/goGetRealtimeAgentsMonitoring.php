<?php
    ...
    if($query_OnlineAgents != NULL) {
        ...
        $data = array_merge($dataInCalls, $dataCallerIDsFromVAC, $dataParkedChannels, $dataNoCalls);            
