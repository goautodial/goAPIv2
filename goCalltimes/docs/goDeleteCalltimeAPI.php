<?php
 ...
 ######################################################
 	...
 	$url = "https://encrypted.goautodial.com/goAPI/goCalltimes/goAPI.php"; #URL to GoAutoDial API. (required)
        ...
        $postfields["call_time_id"] = $_GET['call_time_id']; #Desired Lead Filter id. (required)
...
//	print_r($data);
	...
	if ($output->result=="success") {
	   # Result was OK!
		echo "Delete Success ".$_GET['call_time_id'];	
	 } else {
	   # An error occured
	   	echo $output->result;
	}
