<?php
 ...
 ####################################################
 	...
 	$url = "https://encrypted.goautodial.com/goAPI/goLeadFilters/goAPI.php"; #URL to GoAutoDial API. (required)
        ...
        $postfields["lead_filter_id"] = $_GET['lead_filter_id']; #Desired Lead Filter id. (required)
...
//	print_r($data);
	...
	if ($output->result=="success") {
	   # Result was OK!
		echo "Delete Success ".$_GET['lead_filter_id'];	
	 } else {
	   # An error occured
	   	echo $output->result;
	}
