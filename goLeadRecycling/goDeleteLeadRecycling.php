<?php
  ...
  ****************************************************/
    ...
    // POST or GET Variables
        ...
        $campaign_id = mysqli_real_escape_string($link, $_REQUEST['campaign_id']); //optional
        ...
        if($check_usergroup > 0){
            ...
            if(!empty($campaign_id)){
                ...
                if($deleteResult){
                    ...
                    $log_id = log_action($linkgo, 'DELETE', $session_user, $ip_address, "Deleted All Lead Recycling under Campaign ID: $campaign_id", $groupId, $deleteQuery);
                }
